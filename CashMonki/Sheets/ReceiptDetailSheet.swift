        ...
        VStack(spacing: 0) {
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    // Receipt section - Full width image with containers below
                    if let receiptImage = transactionState.transaction.receiptImage {
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            // Receipt and Invoice Number in single container
                            VStack(spacing: 16) {
                                // Receipt Number row
                                HStack(spacing: 16) {
                                    Text("Receipt Number")
