...
struct EditCategoryDetailSheet: View {
    ...
    private func saveChanges() {
        ...
        // Use the parent name directly from the input field instead of converting from ID
        let parentName = selectedParentCategory
        print("🔥 Using Parent Name directly from input: '\(parentName ?? "None")'")
        print("🔥 Selected Parent Category ID: '\(selectedParentCategoryId?.uuidString ?? "None")'")
