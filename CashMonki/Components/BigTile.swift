...
struct BigTile: View {
    ...
    var body: some View {
        ZStack {
            ...
            if let usageLimitText = usageLimitText, !usageLimitText.isEmpty {
                VStack {
                    Spacer()
                    HStack {
                        Spacer()
        ...
        .padding(.bottom, usageLimitText != nil && !usageLimitText!.isEmpty ? 12 : 2) // Add padding to prevent clipping + 2px base
