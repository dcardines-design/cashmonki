        ...
        VStack(spacing: 0) {
            ...
            GeometryReader { geometry in
                ZStack(alignment: .leading) {
                    ...
                    Rectangle()
                        ...
                        .frame(width: geometry.size.width * (3.0/4.0), height: 4) // Step 3 of 4
                }
            }
            .frame(height: 4)
            ...
            FixedBottomGroup.primary(
                ...
                action: {
                    ...
                    // 🔧 CRITICAL: Set missing hasSetPrimaryCurrency flag for existing users
                    UserDefaults.standard.set(true, forKey: "hasSetPrimaryCurrency")
                    print("🎯 GoalsOnboarding: ✅ FIXED: Set hasSetPrimaryCurrency = true for existing user")
